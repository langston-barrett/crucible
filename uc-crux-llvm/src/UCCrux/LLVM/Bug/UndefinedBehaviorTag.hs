...
instance Eq UndefinedBehaviorTag where
  UndefinedBehaviorTag t1 == UndefinedBehaviorTag t2 =
    ...
    case (t1, t2) of
      (UB.FreeBadOffset CU, UB.FreeBadOffset CU) -> True
      (UB.FreeUnallocated CU, UB.FreeUnallocated CU) -> True
      (UB.DoubleFree CU, UB.DoubleFree CU) -> True
      (UB.MemsetInvalidRegion CU CU CU, UB.MemsetInvalidRegion CU CU CU) -> True
      (UB.ReadBadAlignment CU align1, UB.ReadBadAlignment CU align2) -> align1 == align2
      (UB.WriteBadAlignment CU align1, UB.WriteBadAlignment CU align2) -> align1 == align2
      (UB.PtrAddOffsetOutOfBounds CU CU, UB.PtrAddOffsetOutOfBounds CU CU) -> True
      (UB.CompareInvalidPointer op1 CU CU, UB.CompareInvalidPointer op2 CU CU) -> op1 == op2
      (UB.CompareDifferentAllocs CU CU, UB.CompareDifferentAllocs CU CU) -> True
      (UB.PtrSubDifferentAllocs CU CU, UB.PtrSubDifferentAllocs CU CU) -> True
      (UB.PointerIntCast CU sty1, UB.PointerIntCast CU sty2) -> sty1 == sty2
      (UB.PointerUnsupportedOp CU str1, UB.PointerUnsupportedOp CU str2) -> str1 == str2
      (UB.PointerFloatCast CU sty1, UB.PointerFloatCast CU sty2) -> sty1 == sty2
      (UB.ComparePointerToBV CU CU, UB.ComparePointerToBV CU CU) -> True
      (UB.UDivByZero CU CU, UB.UDivByZero CU CU) -> True
      (UB.SDivByZero CU CU, UB.SDivByZero CU CU) -> True
      (UB.URemByZero CU CU, UB.URemByZero CU CU) -> True
      (UB.SRemByZero CU CU, UB.SRemByZero CU CU) -> True
      (UB.SDivOverflow CU CU, UB.SDivOverflow CU CU) -> True
      (UB.SRemOverflow CU CU, UB.SRemOverflow CU CU) -> True
      (UB.AbsIntMin CU, UB.AbsIntMin CU) -> True
...
instance Ord UndefinedBehaviorTag where
  ...
  -- args["UB.CompareInvalidPointer"] = "op CU CU"
  ...
  -- args["UB.PointerFloatCast"] = "CU sty"
  -- args["UB.PointerIntCast"] = "CU sty"
  -- args["UB.PointerUnsupportedOp"] = "CU str"
  -- args["UB.PoisonValueCreated"] = "p"
  -- args["UB.PtrAddOffsetOutOfBounds"] = 2
  -- args["UB.PtrSubDifferentAllocs"] = 2
  -- args["UB.ReadBadAlignment"] = "CU align"
  ...
  -- args["UB.WriteBadAlignment"] = "CU align"
  --
  -- ORD = [
  --     "UB.FreeBadOffset",
  --     "UB.FreeUnallocated",
  ...
  --         ars = ' '.join(['CU' for _ in range(args[constr])])
  ...
  compare (UndefinedBehaviorTag t1) (UndefinedBehaviorTag t2) =
    case (t1, t2) of
      (UB.FreeBadOffset CU, UB.FreeBadOffset CU) -> EQ
      ...
      (UB.FreeUnallocated CU, UB.FreeUnallocated CU) -> EQ
      ...
      (UB.DoubleFree CU, UB.DoubleFree CU) -> EQ
      ...
      (UB.MemsetInvalidRegion CU CU CU, UB.MemsetInvalidRegion CU CU CU) -> EQ
      ...
      (UB.ReadBadAlignment CU align1, UB.ReadBadAlignment CU align2) -> compare align1 align2
      ...
      (UB.WriteBadAlignment CU align1, UB.WriteBadAlignment CU align2) -> compare align1 align2
      ...
      (UB.PtrAddOffsetOutOfBounds CU CU, UB.PtrAddOffsetOutOfBounds CU CU) -> EQ
      ...
      (UB.CompareInvalidPointer op1 CU CU, UB.CompareInvalidPointer op2 CU CU) -> compare op1 op2
      ...
      (UB.CompareDifferentAllocs CU CU, UB.CompareDifferentAllocs CU CU) -> EQ
      ...
      (UB.PtrSubDifferentAllocs CU CU, UB.PtrSubDifferentAllocs CU CU) -> EQ
      ...
      (UB.PointerIntCast CU sty1, UB.PointerIntCast CU sty2) -> compare sty1 sty2
      ...
      (UB.PointerUnsupportedOp CU str1, UB.PointerUnsupportedOp CU str2) -> compare str1 str2
      ...
      (UB.PointerFloatCast CU sty1, UB.PointerFloatCast CU sty2) -> compare sty1 sty2
      ...
      (UB.ComparePointerToBV CU CU, UB.ComparePointerToBV CU CU) -> EQ
      ...
      (UB.UDivByZero CU CU, UB.UDivByZero CU CU) -> EQ
      ...
      (UB.SDivByZero CU CU, UB.SDivByZero CU CU) -> EQ
      ...
      (UB.URemByZero CU CU, UB.URemByZero CU CU) -> EQ
      ...
      (UB.SRemByZero CU CU, UB.SRemByZero CU CU) -> EQ
      ...
      (UB.SDivOverflow CU CU, UB.SDivOverflow CU CU) -> EQ
      ...
      (UB.SRemOverflow CU CU, UB.SRemOverflow CU CU) -> EQ
      ...
      (UB.AbsIntMin CU, UB.AbsIntMin CU) -> EQ
